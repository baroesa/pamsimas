...
class M_PemakaianAir extends CI_Model
{
    ...
    function tampilData()
    {
        $this->db->select('p.id_pelanggan, p.nama_pelanggan, p.nama_alias, k.id_pakai, k.tahun, k.awal, k.akhir, k.total_pakai, b.nama_bulan, t.status');
