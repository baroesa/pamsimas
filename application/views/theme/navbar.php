      ...
      <li class="nav-item dropdown user-menu">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <li class="user-header bg-dark">
            ...
            <p><?= $session['nama'] ?>
              <small>Member since <?= date($session['tgl_daftar']) ?></small>
            </p>
          </li>

          <!-- Menu user-footer-->
          <li class="user-footer">
            <a href="#" class="btn btn-info"><i class="fas fa-user mr-2"></i>Profile</a>
            <a href="<?= base_url('C_Main/logout'); ?>" onclick="return confirm('Apakah anda yakin ingin keluar?')" class="btn btn-danger float-right">
